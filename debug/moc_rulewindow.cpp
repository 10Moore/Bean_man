...
#include <memory>
#include "../../../QT/QT_Project/Bean_man/rulewindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_RuleWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_RuleWindow_t qt_meta_stringdata_RuleWindow = {
    {
QT_MOC_LITERAL(0, 10), // "RuleWindow"
QT_MOC_LITERAL(11, 11), // "closeWindow"
QT_MOC_LITERAL(23, 0) // ""

    },
    "RuleWindow\0closeWindow\0"
};
...
void RuleWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RuleWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RuleWindow::closeWindow)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject RuleWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_RuleWindow.offsetsAndSize,
    qt_meta_data_RuleWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_RuleWindow_t
, QtPrivate::TypeAndForceComplete<RuleWindow, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
