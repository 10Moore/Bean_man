...
#include <memory>
#include "../../../QT/QT_Project/Bean_man/baseobject.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_baseobject_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_baseobject_t qt_meta_stringdata_baseobject = {
    {
QT_MOC_LITERAL(0, 10) // "baseobject"
...
const QMetaObject baseobject::staticMetaObject = { {
    ...
    qt_meta_stringdata_baseobject.offsetsAndSize,
    qt_meta_data_baseobject,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_baseobject_t
, QtPrivate::TypeAndForceComplete<baseobject, std::true_type>
